...
export default function ShareButtons({
  ...
  const encodedText = encodeURIComponent(
    `Check out ${productName} on Rongonsaaj!`,
  );
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {shareLinks.map(({ label, color, href, icon }) => (
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-white text-xs font-bold transition-all hover:opacity-90 hover:scale-105"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all hover:scale-105 border border-border"
