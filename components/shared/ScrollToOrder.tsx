...
export default function ScrollToOrder() {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 left-1/2 -translate-x-1/2 z-40 md:hidden flex items-center gap-2 bg-orange-500 text-white border-2 border-white px-6 py-3 rounded-full font-extrabold text-sm shadow-lg"
      style={{
