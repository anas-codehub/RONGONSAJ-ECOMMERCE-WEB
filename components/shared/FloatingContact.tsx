...
const WHATSAPP_NUMBER = "01622939274";
const FACEBOOK_PAGE = "https://www.facebook.com/profile.php?id=61586659937832";
const MESSENGER_LINK = "https://www.facebook.com/profile.php?id=61586659937832";
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          height: "56px",
          borderRadius: "50%",
          background: open ? "#3D2B1F" : "#E07B54",
          border: "none",
          cursor: "pointer",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          boxShadow: "0 4px 24px rgba(224,123,84,0.5)",
